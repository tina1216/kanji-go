        ...
        <header class="h-16 flex items-center border-b border-gray-300">
                ...
                {user && <aside class="flex items-center pr-3 space-x-3">
                    ...
                    <div class="flex items-center">
                        <Link to="/home"><a href="/" class="hidden md:block p-3 px-4 pt-2 text-mainBlue rounded-full bg-white baseline hover:text-white hover:bg-mainBlue outline outline-1">Sign Out</a></Link>
                    </div>
                </aside>}
            </header>
        </>
